...
const Routers = () => {
  return Routers_React.createElement(react_router_dom/* HashRouter */.UT, null, Routers_React.createElement(react_router/* Route */.AW, {
    path: RouterPaths.Home,
    exact: true
  }, Routers_React.createElement("div", {
    className: "path-with-header",
    style: {
      paddingTop: 78,
      width: '100%'
    }
  }, Routers_React.createElement(BlogHeader, null), Routers_React.createElement(react_router/* Route */.AW, {
    path: '/',
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [216], () => (__webpack_require__(2666)))
