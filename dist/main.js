...
const Markdown = Article_React.lazy(() => Promise.all(/* import() | markdown */[__webpack_require__.e(216), __webpack_require__.e(666), __webpack_require__.e(9)]).then(__webpack_require__.bind(__webpack_require__, 4351)));
const SingleArticle = props => {
  const [content, setContent] = (0,react.useState)('');
  const reg = /<!--[\S\s]*.*[\S\s]*?-->/;
  const fetchData = (0,react.useCallback)(() => {
    fetch("" + props.path).then(res => res.text()).then(res => {
      setContent(res);
    });
  }, []);
  (0,react.useEffect)(() => {
  ...
  }, !props.onlyTitle ? Article_React.createElement(Markdown, {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [216], () => (__webpack_require__(4406)))
